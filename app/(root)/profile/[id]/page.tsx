...
import QustionTab from "@/components/shared/QustionTab";
...
const Page = async ({ params, searchParams }: URLProps) => {
  ...
  return (
    <>
      <div className="mt-7 flex flex-col-reverse items-start justify-between sm:flex-row">
      ...
      <div className="text-dark300_light900 mt-5 flex gap-10">
